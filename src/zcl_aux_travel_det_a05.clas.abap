CLASS zcl_aux_travel_det_a05 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    TYPES: tt_travel_reported      TYPE TABLE FOR REPORTED zcd_i_travel_a05,
           tt_booking_reported     TYPE TABLE FOR REPORTED zcd_i_booking_a05,
           tt_supplements_reported TYPE TABLE FOR REPORTED zcd_i_booksupp_a05.
...
CLASS zcl_aux_travel_det_a05 IMPLEMENTATION.
    ...
    LOOP AT lt_read_supplements INTO DATA(ls_booking_suppl)
      ...
      LOOP AT GROUP lv_travel_key INTO DATA(ls_supplements_result)
        ...
        LOOP AT GROUP lv_curr INTO DATA(ls_supplement_line).
          ...
          lv_total_supplement_price += ls_supplement_line-price.

        ENDLOOP.

        IF lv_curr EQ <ls_travel>-currency_code.

          <ls_travel>-total_price += lv_total_supplement_price.
