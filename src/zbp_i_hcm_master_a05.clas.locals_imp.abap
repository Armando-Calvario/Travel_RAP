...
CLASS lhc_HCMMaster IMPLEMENTATION.
  ...
  METHOD create.
    ...
    LOOP AT entities INTO DATA(ls_entities).
      ...
      ls_entities-%data-crea_uname     = lv_name.
  ...
  METHOD update.
    ...
    LOOP AT entities INTO DATA(ls_entities).
      ...
      ls_entities-%data-lchg_uname     = lv_name.
...
CLASS lsc_HCM_MASTER_A05 DEFINITION INHERITING FROM cl_abap_behavior_saver.
  PROTECTED SECTION.
...
CLASS lsc_HCM_MASTER_A05 IMPLEMENTATION.
