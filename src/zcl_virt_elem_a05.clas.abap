CLASS zcl_virt_elem_a05 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_virt_elem_a05 IMPLEMENTATION.

  METHOD if_sadl_exit_calc_element_read~get_calculation_info.

    IF iv_entity = 'ZCD_C_TRAVEL_A05'.
  ...
  METHOD if_sadl_exit_calc_element_read~calculate.
    ...
    DATA lt_original_data TYPE STANDARD TABLE OF zcd_c_travel_a05 WITH DEFAULT KEY.
